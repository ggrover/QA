...
#Install CTS pkgs
device.installPackage('/Users/gauravgrover/Dev/android-cts/repository/testcases/CtsDeviceAdmin.apk')
device.installPackage('/Users/gauravgrover/Dev/android-cts/repository/testcases/CtsDelegatingAccessibilityService.apk')
